...
words = ['Move forward in the crowd.', 'Look at the sky.', 'The moon is shining.','Nobody will go out in the darkness.',
         'I borrowed a book from the library.', 'Please, give me the piece of paper.']
...
def check():
    ...
    label.grid(row=11, columnspan=3)
...
def play():
    ...
    btn = Button(root, text="Check", command=check, bg="DodgerBlue2", fg="white", font=('arial', 15))
